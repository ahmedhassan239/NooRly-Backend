...
/**
 * Custom Pivot class for quran_ayahables table.
 * 
 * This pivot table exists in the main database, not in the quran_all_lang database.
 */
class QuranAyahable extends Pivot
{
    /**
     * The connection name for the model.
     * 
     * This ensures the pivot table is accessed from the main database,
     * even though the related model (QuranVerse) uses a different connection.
     *
     * @var string
     */
     ...
     * @var string
     */
    protected $table = 'quran_ayahables';
