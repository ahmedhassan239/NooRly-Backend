...
class SurahHelper
{
    public static function getSurahNames(): array
    {
        return [
            1 => 'Al-Fatihah',
            2 => 'Al-Baqarah',
    ...
    public static function getName(int $number): string
    {
        return self::getSurahNames()[$number] ?? "Surah {$number}";
    }

    /**
     * Get Arabic surah names
     */
    public static function getArabicSurahNames(): array
    {
        return [
            1 => 'الفاتحة',
            2 => 'البقرة',
    ...
    /**
     * Get Arabic name for a specific surah
     */
    public static function getArabicSurahName(int $number): string
    {
