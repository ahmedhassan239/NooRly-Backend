...
{
    /**
     * The database connection for Hadith data.
     */
    private const CONNECTION = 'mysql_hadith';

    /**
     * The table name for hadiths.
     */
    private const TABLE = 'all_hadiths_clean.hadiths';
     ...
     * 
     * @param string|null $source The hadith source/collection
     * @param string|int|null $hadithNo The hadith number
     * @param string $text The Arabic hadith text
     ...
     * @param int $matchPos Position of the match
     ...
     * @param string|int|null $hadithNo
     * @return string
     */
